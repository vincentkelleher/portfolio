    ...
    return (
        <Row id="resume" className="snap-scroll-section">
            <Col lg="8">
                ...
                <Experience>
                    <Experience.Timeline>
                        <Experience.Timeline.Date>05/2019 - 03/2020</Experience.Date>
                ...
                <Experience>
                    <Experience.Timeline>
                        <Experience.Timeline.Date>04/2018 - 05/2019</Experience.Date>
                        <Experience.Timeline.Company><img alt="Logo de onepoint" src={Onepoint} /></Experience.Company>
                    </Experience.Timeline>
